...
from track.StraightTrack import StraightTrack
...
plane_03 = Plane.create_new("Test Plane 3", 18000, 2000, 7000, 2000, 200, 5, 2, 30)
plane_04 = Plane.create_new()
plane_05 = Plane.create_new("Test Plane big")
plane_06 = Plane.create_new("3D Calculator Test Plane", 6, 4,6, 3, 2, 3, 1, 36)
print("Create Plane done")
print("Start Create StraightTrack")
straight_track_01 = StraightTrack.create_new(plane_01, "Test Straight 1", 700, 800, 10, 20, 15, rasperry_pie=main_pie, motor_controller=motor_controller_01, motor_controller_channel=1, ina_powersensor=power_sensor_01, relay=relay_01, analog=False,  dead=False,blocked=False, speed_limit=0.8)
straight_track_02 = StraightTrack.create_new(plane_01,"Test Straight 2", 120000, 5000, 200, 100, 21, 4,rasperry_pie=main_pie, motor_controller=motor_controller_01, motor_controller_channel=2, ina_powersensor=power_sensor_02, relay=relay_03, exact=True, blocked=True, analog=False, speed_limit=2.3)
straight_track_03 = StraightTrack.create_new(plane_02,x_connection_a= 300, y_connection_a= 200, x_connection_b=1200, y_connection_b= 250)
straight_track_04 = StraightTrack.create_new(plane_01, "Test Straight 4", 40000, 3000 ,22, 50, rasperry_pie=sub_pie, motor_controller=motor_controller_06, motor_controller_channel = 2, ina_powersensor = power_sensor_09, relay = relay_08, speed_limit = 2.1, analog = True)
print("Create StraightTrack done")
