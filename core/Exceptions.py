...
class Ina219AmpSensException(Exception):
    pass

class Ads1115ADConverterException(Exception):
    pass

class GPIOException(Exception):
    pass

class M3HMotorcontrollerException(Exception):
    pass

class TrackException(Exception):
    pass

class TrackGroupException(Exception):
    pass
